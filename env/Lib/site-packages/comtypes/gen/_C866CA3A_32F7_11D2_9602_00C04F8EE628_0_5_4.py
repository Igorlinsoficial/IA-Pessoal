...
__all__ = [
    'SPCT_DICTATION', 'eLEXTYPE_LETTERTOSOUND', 'ISpeechObjectToken',
    'DISPIDSPTSI_SelectionLength', 'ISpeechPhraseAlternates',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpeechPhraseRule',
    'DISPID_SLWType', 'DISPID_SMSGetData', 'SASClosed',
    'SSSPTRelativeToEnd', 'DISPID_SRRTStreamTime',
    'SpeechSpecialTransitionType', 'DISPID_SPPValue', 'SPCT_SLEEP',
    'SpTextSelectionInformation', 'SPAUDIOSTATE', 'SPLO_DYNAMIC',
    'SAFT44kHz16BitMono', 'DISPID_SRCEFalseRecognition', 'SLODynamic',
    'SPEI_TTS_AUDIO_LEVEL', 'SVP_14', 'DISPID_SGRAddState',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SPISaveToMemory', 'SPVPRI_OVER',
    'SPRULE', 'DISPID_SRCEEnginePrivate',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SRAudioInputStream',
    'SECFNoSpecialChars', 'ISpeechLexicon', 'SPEI_VOICE_CHANGE',
    'SPCT_SUB_COMMAND', 'DISPID_SREmulateRecognition',
    'DISPID_SpeechMMSysAudio', 'SPVISEMES', 'DISPID_SPIRule',
    'DISPID_SPPs_NewEnum', 'SRTSMLTimeout',
    'DISPID_SRSCurrentStreamNumber', 'ISpeechPhraseProperties',
    'DISPID_SOTSetId', 'SINoise', 'Speech_Max_Pron_Length',
    'SPFM_OPEN_READONLY', 'SPRECOSTATE', 'SVEPrivate',
    'ISpeechAudioStatus', 'SPCT_COMMAND', 'SPEI_END_SR_STREAM',
    'DISPID_SVSkip', 'SPEI_SOUND_END', 'SAFTCCITT_uLaw_44kHzMono',
    'SSTTTextBuffer', 'DISPID_SGRSTType', 'SVSFParseMask', 'SVP_15',
    'SpeechEngineConfidence', 'SVSFIsNotXML', 'SPEI_MIN_SR',
    'eWORDTYPE_DELETED', 'SPPHRASERULE', 'SpeechAudioProperties',
    'ISpeechPhraseElements', 'DISPID_SGRSAddRuleTransition', 'SVP_4',
    ...
    'SP_VISEME_19', 'SPINTERFERENCE_TOOQUIET', 'SPSEMANTICERRORINFO',
    'DISPID_SVSyncronousSpeakTimeout', 'ISpNotifyTranslator',
    'DISPID_SPPName', 'SVP_9', 'ISpeechXMLRecoResult',
    'SpeechBookmarkOptions', 'SWPKnownWordPronounceable',
    'DISPID_SDKGetBinaryValue', 'SLTUser', 'DISPID_SLWLangId',
    'DISPID_SPIEngineId', 'IInternetSecurityManager', 'SPRS_ACTIVE',
    'SP_VISEME_0', 'DISPID_SpeechPhraseRules',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SDKGetlongValue',
    'DISPID_SPIAudioStreamPosition', 'SAFTGSM610_22kHzMono',
    'DISPID_SGRSTsCount', 'DISPID_SVRate', 'DISPID_SLPLangId',
    'SAFTText', 'DISPID_SPRsItem', 'STCLocalServer',
    ...
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SVEAudioLevel',
    'DISPID_SRGReset', 'SAFT48kHz16BitStereo', 'SAFT8kHz16BitStereo',
    'SpMemoryStream', 'SpeechAudioFormatGUIDWave',
    'SAFT44kHz16BitStereo', 'SpeechRecognizerState',
    'ISpeechRecognizerStatus', 'DISPID_SPIGetText', 'SpMMAudioIn',
    'DISPID_SCSBaseStream', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SPARecoResult', 'ISpRecognizer2', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SVSInputSentenceLength', 'ISpeechLexiconWords',
    'SP_VISEME_14', 'DISPID_SPEsCount', 'DISPID_SPPParent',
    'DISPID_SPPChildren', 'SPWORDLIST', 'DISPID_SpeechLexiconProns',
    'SPBINARYGRAMMAR', 'DISPID_SLAddPronunciation',
    'DISPID_SRGDictationLoad', 'DISPID_SPRuleName',
    'SpeechAddRemoveWord', 'DISPID_SRCEAudioLevel', 'SpVoice',
    ...
    'STSF_FlagCreate', 'SGRSTTWildcard', 'STSF_LocalAppData',
    'DISPID_SASetState', 'DISPIDSPTSI', 'SPEI_ADAPTATION',
    'SPSFunction', 'DISPID_SpeechPhraseBuilder',
    'SPINTERFERENCE_NOSIGNAL', 'SPAS_STOP', 'SPEI_RESERVED3',
    'Speech_Default_Weight', 'DISPID_SMSAMMHandle', 'SPPHRASE',
    'SAFT22kHz16BitMono', 'SSSPTRelativeToStart',
    'DISPID_SRCEStartStream', 'SAFT12kHz16BitStereo',
    'DISPID_SVStatus', 'IEnumString', 'SAFTADPCM_22kHzStereo',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPPS_Modifier',
    'SAFTGSM610_8kHzMono', 'SAFT22kHz16BitStereo', 'SP_VISEME_3',
    'SVSFParseAutodetect', 'SPAO_RETAIN_AUDIO',
    'SAFTCCITT_uLaw_22kHzMono', 'SpeechRuleAttributes',
    'SREStreamStart', 'DISPID_SPAStartElementInResult',
    'DISPID_SPRFirstElement', 'SpeechGrammarRuleStateTransitionType',
    'SPLO_STATIC', 'eLEXTYPE_PRIVATE10', 'SpeechPropertyAdaptationOn',
    'SAFT22kHz8BitStereo', 'DISPID_SRGRules', 'SPAO_NONE',
    'SVSFParseSsml', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SMSALineId', 'SDTRule', 'DISPID_SRCEPropertyStringChange',
    'SAFTNonStandardFormat', 'SPSERIALIZEDRESULT', 'SPSEMANTICFORMAT',
    'DISPID_SPIStartTime', 'SVPNormal', 'SVPAlert',
    'DISPID_SPPsCount', 'SPSVerb', 'SPBO_AHEAD',
    'DISPID_SRAudioInput', 'SVESentenceBoundary', 'DISPID_SAFType',
    'DISPID_SGRClear', 'SPEI_PHONEME', 'DISPID_SpeechRecoResultTimes',
    ...
    'SPRULESTATE', 'DISPID_SRCEBookmark', 'SpUnCompressedLexicon',
    'SECNormalConfidence', 'DISPID_SPRuleEngineConfidence',
    'SVF_Stressed', 'DISPID_SVEBookmark', 'SPLEXICONTYPE',
    'DISPID_SpeechVoiceEvent', 'SITooFast', 'DISPID_SRCEInterference',
    'DISPID_SRRAudioFormat', 'SVEVoiceChange', 'SASRun',
    'DISPID_SPRsCount', 'SPSNotOverriden', 'SRADynamic',
    'SP_VISEME_16', 'SGLexical', 'SREAdaptation',
    'DISPID_SPEAudioStreamOffset', 'SpInProcRecoContext',
    'SPSTREAMFORMATTYPE', 'SPAS_RUN',
    'DISPID_SASCurrentDevicePosition', 'SPWT_PRONUNCIATION',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SASState', 'SRAImport',
    'SVEPhoneme', 'SpeechCategoryRecoProfiles', 'tagSTATSTG',
    'SAFT44kHz8BitStereo', 'SPVPRI_ALERT',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRRPhraseInfo',
    'SECHighConfidence', 'SpeechPropertyResourceUsage',
    'ISpRecoResult', 'DISPID_SRRecognizer', 'SECFIgnoreWidth',
    'DISPID_SRCERecognizerStateChange', 'SAFT16kHz8BitMono',
    'DISPID_SMSADeviceId', 'SpeechRecoEvents', 'DISPID_SPRText',
    'SpeechDataKeyLocation', 'DISPID_SOTGetAttribute',
    'SAFTGSM610_44kHzMono', 'ISpLexicon', 'SDKLCurrentUser',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SpeechRecoContext',
    'SP_VISEME_18', 'DISPID_SABIBufferSize', 'SPPS_RESERVED3',
    'DISPID_SpeechLexiconPronunciation', 'SPWORDTYPE',
    'SpeechAudioFormatGUIDText', 'ISpEventSink', 'ISpNotifySink',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SRCState',
    'SASPause', 'DISPID_SRCERequestUI', 'DISPID_SGRsCommitAndSave',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SGRSTNextState',
    'SPAR_Medium', 'ISpeechPhraseInfoBuilder',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'IInternetSecurityMgrSite', 'ISpProperties', 'SAFTDefault',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SRGCmdLoadFromFile',
    'SPEVENT', 'ISpeechVoiceStatus', 'SPSNoun', 'SAFT16kHz8BitStereo',
    'ISpeechObjectTokens', 'ISpRecoGrammar2',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SGRsItem',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SDKDeleteValue',
    'eLEXTYPE_RESERVED7', 'DISPID_SPAsCount', 'eLEXTYPE_PRIVATE18',
    'ISpeechPhraseProperty', 'DISPID_SLWsCount', 'DISPID_SLPsItem',
    'DISPID_SVGetVoices', 'DISPID_SVESentenceBoundary',
    'SPFM_CREATE_ALWAYS', 'SPLOADOPTIONS', 'DISPID_SWFEExtraData',
    'DISPID_SLPSymbolic', 'eLEXTYPE_RESERVED10',
    'SAFTGSM610_11kHzMono', 'DISPID_SOTIsUISupported', 'SVP_5',
    'DISPID_SAFGuid', 'SPPS_SuppressWord', 'DISPID_SLPs_NewEnum',
    'SPWT_LEXICAL', 'SPBO_PAUSE', 'SP_VISEME_6', 'DISPID_SOTCDefault',
    'DISPID_SVVoice', 'eLEXTYPE_VENDORLEXICON', 'DISPID_SOTCSetId',
    'SAFT12kHz16BitMono', 'DISPID_SGRSTransitions',
    'DISPID_SGRSTText', 'SPEI_RESERVED2', 'eLEXTYPE_USER',
    'SPINTERFERENCE_TOOFAST', 'ISpeechPhraseReplacement',
    'DISPID_SGRSTWeight', 'SVSFDefault', 'SAFTCCITT_ALaw_44kHzMono',
    'eLEXTYPE_APP', 'DISPID_SDKDeleteKey', 'DISPID_SRGetRecognizers',
    'SAFTExtendedAudioFormat', 'SPDKL_CurrentConfig',
    'eLEXTYPE_PRIVATE9', 'ISpeechWaveFormatEx', 'SpeechLexiconType',
    'SPPS_Verb', 'SpeechDictationTopicSpelling', 'DISPID_SGRsCommit',
    'DISPID_SRCVoice', 'DISPID_SOTRemoveStorageFileName',
    'SpeechInterference', 'SpeechTokenKeyFiles',
    'DISPID_SRCRetainedAudio', 'SPFILEMODE', 'DISPID_SDKEnumKeys',
    'DISPID_SpeechPhraseAlternate', 'SPGS_DISABLED',
    'DISPID_SRGCommit', 'DISPID_SMSSetData',
    'DISPID_SWFEBitsPerSample', 'DISPID_SPEAudioSizeTime',
    'SPBO_NONE', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SVGetAudioOutputs', 'SpeechPartOfSpeech',
    'DISPID_SpeechObjectTokenCategory', 'ISpeechPhraseElement',
    'SDTPronunciation', 'SPRECOGNIZERSTATUS', 'SVP_7',
    'SpeechAllElements', 'DISPID_SGRs_NewEnum', 'eLEXTYPE_PRIVATE17',
    'SPXMLRESULTOPTIONS', '_ISpeechVoiceEvents', 'STCAll',
    'SPSHORTCUTPAIRLIST', 'SPEI_END_INPUT_STREAM', 'SpLexicon',
    'STCInprocServer', 'SDKLCurrentConfig',
    'DISPID_SAFSetWaveFormatEx', 'SAFTADPCM_8kHzStereo',
    'DISPID_SRCERecognition', 'SAFT11kHz8BitMono',
    'SpeechAudioFormatType', 'SRESoundStart', 'SAFT24kHz16BitStereo',
    'DISPID_SGRSTsItem', 'DISPID_SpeechLexiconWord', 'SPPARTOFSPEECH',
    'SAFT12kHz8BitMono', 'ISpRecoContext', 'SLOStatic',
    'DISPID_SRRTimes', 'DISPID_SVSLastStreamNumberQueued',
    'SAFTADPCM_22kHzMono', 'eWORDTYPE_ADDED', 'DISPID_SLWs_NewEnum',
    'SP_VISEME_11', 'DISPID_SPERetainedStreamOffset', 'SGRSTTWord',
    'ISpSerializeState', 'SPXRO_SML', 'DISPID_SPRuleFirstElement',
    'DISPID_SPRuleChildren', 'SVSFUnusedFlags',
    'SpStreamFormatConverter', 'DISPID_SPEsItem',
    'DISPID_SPRuleParent', 'eLEXTYPE_RESERVED6', 'SVSFIsFilename',
    'SpeechPropertyHighConfidenceThreshold', 'SPPHRASEREPLACEMENT',
    'ISpeechRecoResult', 'DISPID_SVEVoiceChange',
    'ISpeechTextSelectionInformation', 'DISPID_SRCESoundEnd',
    'SpeechDisplayAttributes', 'SpeechCategoryRecognizers',
    'ISpeechBaseStream', 'SpeechRunState', 'DISPID_SGRsAdd',
    'DISPID_SVIsUISupported', 'SPWORD', 'DISPID_SOTsItem',
    'SDA_Two_Trailing_Spaces', 'SPEI_MAX_TTS',
    'DISPID_SpeechRecognizer', 'SAFTCCITT_uLaw_22kHzStereo',
    'SP_VISEME_9', 'DISPID_SVEEnginePrivate', 'eLEXTYPE_PRIVATE7',
    'ISpRecognizer3', 'SSFMCreateForWrite', 'DISPID_SOTDisplayUI',
    'SPSHT_EMAIL', 'DISPID_SRIsUISupported', 'STCInprocHandler',
    'DISPID_SGRName', 'SpeechAudioState', 'SVF_None',
    'SPRST_INACTIVE', 'DISPID_SRCEAdaptation',
    'DISPID_SRGSetWordSequenceData', 'SRADefaultToActive',
    'DISPID_SRRTLength', 'DISPID_SFSOpen', 'SPBO_TIME_UNITS',
    'ISequentialStream', 'DISPID_SGRSTPropertyName',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SAFT24kHz8BitMono',
    'ISpEventSource', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SPIAudioSizeTime', 'SAFTCCITT_ALaw_11kHzMono',
    'SDTAlternates', 'SPPS_Noun', 'DISPID_SpeechPhraseProperty',
    'SpeechCategoryVoices', 'SpSharedRecoContext',
    'SVEStartInputStream', 'DISPID_SRCSetAdaptationData',
    'ISpObjectWithToken', 'SPPS_NotOverriden', 'SPPS_RESERVED2',
    'DISPID_SOTDataKey', 'SP_VISEME_21', 'DISPID_SVSRunningState',
    'SpInprocRecognizer', 'SPAUDIOSTATUS', 'SDTReplacement',
    'ISpeechPhraseInfo', 'SpeechMicTraining',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SBSFormat',
    'DISPID_SADefaultFormat', 'SAFTNoAssignedFormat',
    'DISPID_SVAudioOutput', 'DISPID_SpeechFileStream',
    'SPGRAMMARSTATE', 'DISPID_SRCVoicePurgeEvent',
    'SpeechTokenShellFolder', 'SRTAutopause', 'SPAS_CLOSED',
    'SRARoot', 'SpPhoneConverter', 'SPSModifier',
    'ISpeechAudioFormat', 'SINone', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SRGCmdLoadFromObject', 'SECFEmulateResult',
    'DISPID_SGRsCount', 'DISPID_SRSetPropertyString', 'SPWT_DISPLAY',
    'SGSExclusive', 'DISPID_SVSLastResult', 'SPEI_PHRASE_START',
    'DISPID_SPAsItem', 'DISPID_SpeechRecoResult2', 'SFTInput',
    'SPEI_RECOGNITION', 'DISPID_SRCEHypothesis',
    'DISPID_SRRTTickCount', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SRCreateRecoContext', 'SpMMAudioEnum',
    'DISPID_SPRules_NewEnum', 'DISPID_SVSInputWordLength',
    'SPEI_REQUEST_UI', 'SPAR_Unknown', 'ISpGrammarBuilder', 'IStream',
    'DISPID_SRCPause', 'SREStreamEnd', 'SGSDisabled',
    'DISPID_SPRDisplayAttributes', 'DISPID_SOTId', 'DISPID_SPACommit',
    'DISPID_SPRNumberOfElements', 'SREPhraseStart',
    'SRSInactiveWithPurge', 'ISpeechGrammarRuleState',
    'SPRST_INACTIVE_WITH_PURGE', 'SWTDeleted', 'SPEI_VISEME',
    'eLEXTYPE_PRIVATE12', 'DISPID_SGRAttributes', 'SPINTERFERENCE',
    'SRERecognition', '__MIDL_IWinTypes_0009', 'SSFMCreate',
    'SREPropertyStringChange', 'ISpRecoContext2', 'SPSHORTCUTTYPE',
    'SVP_16', 'SpNullPhoneConverter', 'SPDKL_LocalMachine',
    'DISPID_SVWaitUntilDone', 'SGDSActive', 'SPSInterjection',
    'ISpeechObjectTokenCategory', 'DISPID_SAEventHandle',
    'SGSEnabled', 'DISPID_SRCCreateResultFromMemory',
    'eLEXTYPE_PRIVATE13', 'SpeechGrammarWordType',
    'DISPID_SPEDisplayAttributes', 'SRAInterpreter', 'ISpPhrase',
    'ISpStreamFormat', 'DISPID_SPEDisplayText',
    'DISPIDSPTSI_SelectionOffset', 'SpeechTokenValueCLSID',
    'DISPID_SGRSTPropertyValue', 'SPSLMA', 'SGDSActiveWithAutoPause',
    'eLEXTYPE_PRIVATE14', 'SVSFParseSapi', 'SPEI_HYPOTHESIS',
    'ISpeechPhraseRules', 'SpeechPropertyResponseSpeed',
    'DISPID_SRGId', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SWFEFormatTag', 'SPAR_Low', 'SRCS_Disabled',
    'DISPID_SLAddPronunciationByPhoneIds', 'SDKLLocalMachine',
    'SPBOOKMARKOPTIONS', 'DISPID_SOTs_NewEnum', 'SP_VISEME_5',
    'ISpeechMMSysAudio', 'SREInterference', 'SpeechGrammarState',
    'SVSFNLPSpeakPunc', 'DISPID_SpeechPhraseInfo',
    'DISPID_SDKEnumValues', 'DISPID_SpeechAudio',
    'DISPID_SWFEBlockAlign', 'ISpDataKey', 'SGPronounciation',
    'DISPID_SVSLastBookmarkId', 'DISPID_SLPsCount',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpeechGrammarRules', 'SRAONone',
    'SpeechPropertyNormalConfidenceThreshold', 'SPPS_Function',
    'SDKLDefaultLocation', 'SAFTADPCM_11kHzStereo',
    'ISpeechRecoGrammar', 'DISPID_SPIReplacements',
    'DISPID_SPEs_NewEnum', 'DISPID_SRGRecoContext',
    'DISPID_SPRuleConfidence', 'SRSEIsSpeaking', 'SP_VISEME_4',
    'SPSMF_UPS', 'DISPID_SpeechDataKey',
    'ISpPhoneticAlphabetSelection', 'SpeechLoadOption',
    'ISpeechLexiconPronunciations', 'DISPID_SPPEngineConfidence',
    'DISPID_SpeechObjectTokens', 'DISPID_SPEPronunciation',
    'SWPUnknownWordPronounceable', 'SRTStandard',
    'DISPID_SRCAudioInInterferenceStatus', 'SpeechFormatType',
    ...
    'SREAudioLevel', 'DISPID_SVSCurrentStreamNumber',
    'ISpeechPhoneConverter', 'DISPID_SPIGrammarId',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SpeechBaseStream',
    'SAFTCCITT_ALaw_22kHzMono', 'SpAudioFormat', 'SPEI_RESERVED6',
    'ISpPhoneConverter', 'SPSUnknown', 'DISPID_SVEPhoneme',
    'DISPID_SRCERecognitionForOtherContext', 'SpeechCategoryAudioOut',
    'SAFT48kHz8BitStereo', 'SPDKL_CurrentUser', 'SVSFNLPMask',
    'SpeechRecoContextState',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SWFEChannels', 'SRAORetainAudio',
    'DISPID_SPPFirstElement', 'SRTReSent', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SGRSTPropertyId', 'SAFT16kHz16BitMono',
    'DISPID_SLGetGenerationChange', 'SVEEndInputStream',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SVResume',
    'SAFT24kHz16BitMono', 'DISPID_SRRDiscardResultInfo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SVSLastBookmark',
    'DISPID_SRGState', 'SpeechUserTraining', 'DISPID_SVPause',
    'SPPS_RESERVED4', 'SAFT32kHz16BitStereo',
    'DISPID_SWFEAvgBytesPerSec', 'SPEI_START_SR_STREAM',
    'SpeechEmulationCompareFlags', 'DISPID_SRState', 'SVP_19',
    'DISPID_SFSClose', 'eLEXTYPE_PRIVATE1', 'SREFalseRecognition',
    'SPINTERFERENCE_TOOSLOW', 'SPCT_SUB_DICTATION', 'SPSHT_OTHER',
    'DISPID_SRSetPropertyNumber', 'DISPID_SGRsDynamic',
    'SPEI_TTS_BOOKMARK', 'SAFT32kHz8BitStereo', 'SREHypothesis',
    'SpeechVoiceSpeakFlags', 'SVP_11', 'ISpeechRecoContext',
    'SBONone', 'ISpeechResourceLoader', 'DISPID_SLGetPronunciations',
    'SP_VISEME_7', 'ISpeechVoice', 'SWTAdded', 'SpObjectToken',
    'ISpeechGrammarRuleStateTransition', 'SITooLoud',
    'DISPID_SVEViseme', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SPEActualConfidence', 'DISPID_SDKOpenKey',
    'DISPID_SRGCmdSetRuleState', '_SPAUDIOSTATE',
    'DISPID_SPIEnginePrivateData', 'ISpResourceManager',
    'DISPID_SPEEngineConfidence', 'DISPID_SASCurrentSeekPosition',
    'ISpObjectTokenCategory', 'SPEI_MIN_TTS', 'SPPS_Interjection',
    'DISPID_SLGenerationId', 'SDTDisplayText', 'DISPID_SRStatus',
    'SAFT48kHz8BitMono', 'DISPID_SRGCmdLoadFromMemory',
    '_RemotableHandle', 'SPVOICESTATUS', 'DISPID_SVVolume',
    'SPSSuppressWord', 'SPVPRI_NORMAL', 'SPEI_MAX_SR',
    'DISPID_SpeechAudioStatus', 'IEnumSpObjectTokens',
    'DISPID_SPILanguageId', 'ISpPhraseAlt',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SDKSetStringValue',
    'DISPID_SpeechAudioBufferInfo', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SPPId', 'SpResourceManager', 'ISpShortcut',
    'SpeechRecognitionType', 'SpPhraseInfoBuilder',
    'SPINTERFERENCE_TOOLOUD', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SASFreeBufferSpace', 'SPPHRASEPROPERTY', 'SRCS_Enabled',
    'SVEAudioLevel', 'SpeechRecoProfileProperties', 'SPCONTEXTSTATE',
    'SP_VISEME_12', 'DISPID_SRRRecoContext', 'DISPID_SRSAudioStatus',
    'DISPID_SPPBRestorePhraseFromMemory', 'SLTApp', 'SpeechRuleState',
    'ISpeechGrammarRule', 'DISPID_SVAlertBoundary',
    'SPEI_INTERFERENCE', 'SpeechCategoryPhoneConverters',
    'SAFT8kHz16BitMono', 'DISPID_SPRuleId', 'DISPID_SPIProperties',
    'SPWF_INPUT', 'DISPID_SBSWrite', 'DISPID_SLPPartOfSpeech',
    'SRTEmulated', 'ISpeechLexiconWord', 'SPSHORTCUTPAIR',
    'DISPID_SRRSpeakAudio', 'DISPID_SpeechPhraseElements',
    'SPAS_PAUSE', 'SSTTWildcard', 'DISPID_SWFESamplesPerSec',
    'SP_VISEME_13', 'STSF_CommonAppData', 'SDTAudio', 'SGRSTTRule',
    'DISPID_SASNonBlockingIO', 'DISPID_SpeechLexiconWords',
    'SECLowConfidence', 'DISPID_SABufferNotifySize', 'SVEAllEvents',
    ...
    'SPPS_Unknown', 'DISPID_SRDisplayUI', 'DISPIDSPRG',
    'eLEXTYPE_RESERVED4', 'eLEXTYPE_PRIVATE20',
    'DISPID_SpeechPhoneConverter', 'SPAUDIOBUFFERINFO',
    'DISPID_SPCPhoneToId', 'SPGS_EXCLUSIVE', 'ISpeechPhraseAlternate',
    'SPWAVEFORMATTYPE', 'ISpeechRecoResultDispatch', 'SPSHT_Unknown',
    'SpeechRetainedAudioOptions',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SOTCGetDataKey', 'SRESoundEnd', 'SVSFIsXML', 'SRAExport',
    'DISPID_SRIsShared', 'eLEXTYPE_PRIVATE5',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SRGetPropertyNumber',
    'SPADAPTATIONRELEVANCE', 'SPFM_OPEN_READWRITE',
    'SAFT12kHz8BitStereo', 'ISpObjectToken', 'eLEXTYPE_PRIVATE4',
    'DISPID_SpeechGrammarRules', 'SpeechRegistryLocalMachineRoot',
    'SPEI_WORD_BOUNDARY', 'SECFDefault',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SpStream',
    'SPINTERFERENCE_NOISE', 'DISPID_SpeechPhraseRule',
    'SPPS_Noncontent', 'SAFT11kHz16BitStereo', 'DISPID_SGRSRule',
    'SP_VISEME_17', 'SVEWordBoundary', 'DISPID_SPRs_NewEnum',
    'DISPID_SPCIdToPhone', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SpeechVoiceStatus', 'SVP_2', 'SREAllEvents',
    'ISpeechAudioBufferInfo', 'SpeechVisemeType', 'DISPID_SGRId',
    'ISpStream', 'ISpPhoneticAlphabetConverter', 'SINoSignal',
    'SAFTADPCM_11kHzMono', 'SpPhoneticAlphabetConverter',
    'SAFTTrueSpeech_8kHz1BitMono', 'eLEXTYPE_PRIVATE8',
    'SPGRAMMARWORDTYPE', 'SVP_17', 'SASStop',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRSClsidEngine',
    'SAFT8kHz8BitMono', 'SITooSlow', 'SAFT44kHz8BitMono',
    'DISPID_SRRAudio', 'DISPID_SLWsItem', 'SpeechStreamFileMode',
    'DISPID_SRCBookmark', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SVPriority', 'SGLexicalNoSpecialChars',
    'DISPID_SLPPhoneIds', 'SPCS_ENABLED', 'SVSFlagsAsync',
    'SPEI_SR_PRIVATE', 'SGDisplay', 'SPSHT_NotOverriden',
    'DISPID_SpeechGrammarRuleState', 'SFTSREngine',
    'SPEI_TTS_PRIVATE', 'SpWaveFormatEx', 'SpObjectTokenCategory',
    'SP_VISEME_15', 'DISPID_SLPType', 'DISPID_SDKCreateKey',
    'eLEXTYPE_PRIVATE6', 'DISPID_SOTCategory', 'SRERequestUI',
    'SPEI_RESERVED1', 'SPAR_High', 'SRSActiveAlways',
    'DISPID_SGRSAddWordTransition', 'DISPID_SRCEPhraseStart',
    'DISPID_SABIEventBias', 'SVP_3',
    'SpeechGrammarTagUnlimitedDictation', 'SAFTADPCM_8kHzMono',
    'ISpAudio', 'SRTExtendableParse', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SOTMatchesAttributes', 'ISpStreamFormatConverter',
    'SVP_18', 'SREPropertyNumChange', 'SRATopLevel',
    'eLEXTYPE_RESERVED8', 'SPCATEGORYTYPE', 'SPRECORESULTTIMES',
    'DISPID_SOTCId', 'DISPID_SPPsItem', 'ISpeechDataKey',
    'SP_VISEME_10', 'SPWORDPRONUNCIATION', 'eLEXTYPE_PRIVATE15',
    'SAFT48kHz16BitMono', 'SAFT32kHz8BitMono', 'SGRSTTEpsilon',
    'SREPrivate', 'DISPID_SBSSeek', 'SPFM_CREATE',
    'SpeechTokenIdUserLexicon', 'SRSEDone', 'SPGS_ENABLED',
    'DISPID_SABIMinNotification', 'SREStateChange',
    'eLEXTYPE_USER_SHORTCUT', 'SPCS_DISABLED', 'SAFT16kHz16BitStereo',
    'SPSERIALIZEDPHRASE', 'DISPID_SpeechVoice',
    'DISPID_SRGCmdSetRuleIdState', 'SVP_21',
    'DISPID_SLWPronunciations', 'SPXRO_Alternates_SML',
    'eLEXTYPE_RESERVED9', 'DISPID_SVEWord',
    'DISPID_SpeechPhraseProperties', 'SRSActive', 'DISPID_SPCLangId',
    'DISPID_SOTGetDescription', 'SPEVENTENUM',
    'DISPID_SRGCmdLoadFromResource', 'SSFMOpenReadWrite',
    'SP_VISEME_20', 'DISPID_SAStatus', 'ISpeechLexiconPronunciation',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SVEStreamEnd',
    'DISPID_SDKGetStringValue', 'SVEBookmark',
    'DISPID_SRCEPropertyNumberChange', 'SPRS_INACTIVE',
    'SGRSTTDictation', 'SP_VISEME_8', 'SpeechStreamSeekPositionType',
    'DISPID_SRCCreateGrammar', 'DISPID_SABufferInfo',
    'DISPID_SpeechGrammarRule', 'SPDKL_DefaultLocation',
    'SREBookmark', 'SVSFVoiceMask', 'SpeechEngineProperties',
    'DISPID_SPAPhraseInfo', 'SVF_Emphasis', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SVSVisemeId', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SpeechPhraseReplacement', 'ISpXMLRecoResult',
    'SpShortcut', 'tagSPPROPERTYINFO', 'DISPID_SVEStreamStart',
    'DISPID_SPPConfidence', 'DISPID_SOTsCount', 'UINT_PTR',
    'DISPID_SVSpeakStream', 'ISpeechRecoResult2', 'SpeechAudioVolume',
    'STSF_AppData', 'DISPID_SRCRequestedUIType', 'SPEI_RESERVED5',
    'SGRSTTTextBuffer', 'SAFT32kHz16BitMono', 'DISPID_SpeechLexicon',
    'SSFMOpenForRead', 'SPRST_NUM_STATES',
    'DISPID_SPPNumberOfElements', 'DISPID_SPEAudioTimeOffset',
    'Speech_Max_Word_Length', 'SPEI_RECO_OTHER_CONTEXT',
    'SpMMAudioOut', 'DISPID_SGRsFindRule', 'SVP_6',
    'SpeechTokenContext', 'SVP_10', 'DISPID_SpeechRecognizerStatus',
    'SGDSInactive', 'DISPID_SVSInputSentencePosition',
    'ISpeechRecognizer', 'SBOPause', 'SpeechVoicePriority',
    'SVSFPersistXML', 'DISPID_SRCEventInterests',
    'DISPID_SRGDictationSetState', 'SpeechTokenKeyUI',
    'DISPID_SGRSTRule', 'DISPID_SRRSetTextFeedback', 'SVP_13',
    'SpeechDiscardType', 'SAFT22kHz8BitMono', 'ISpMMSysAudio',
    'DISPID_SVEventInterests', 'ISpVoice', 'SPDATAKEYLOCATION',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SRCEEndStream',
    'DISPID_SPRulesItem', 'DISPID_SpeechAudioFormat', 'SPRST_ACTIVE',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPWF_SRENGINE',
    'ISpeechFileStream', 'eLEXTYPE_PRIVATE19',
    'DISPID_SOTGetStorageFileName', 'SpeechGrammarTagDictation',
    'SPEI_RECO_STATE_CHANGE', 'SVP_1', 'SPEVENTSOURCEINFO',
    'SpFileStream', 'SPRECOCONTEXTSTATUS', 'DISPID_SVSPhonemeId',
    'WAVEFORMATEX', 'SPEI_SR_BOOKMARK', 'DISPID_SLWWord',
    'DISPID_SRSNumberOfActiveRules', 'ISpRecognizer',
    'SpeechTokenKeyAttributes', 'SSTTDictation', 'SVP_20',
    'DISPID_SRCRetainedAudioFormat', 'SPFM_NUM_MODES',
    'SpeechGrammarTagWildcard', 'ISpNotifySource', 'SITooQuiet',
    'ISpeechCustomStream', 'STCRemoteServer', 'DISPID_SRProfile',
    'DISPID_SpeechObjectToken', 'DISPID_SPELexicalForm', 'SVP_12',
    'SAFT11kHz16BitMono', 'DISPID_SRGDictationUnload',
    'DISPID_SPAs_NewEnum', 'SVPOver', 'ISpeechRecoResultTimes',
    'SP_VISEME_1', 'ISpRecoCategory', 'SpSharedRecognizer',
    'SpeechVisemeFeature', 'DISPID_SGRInitialState', 'DISPID_SBSRead',
    'DISPID_SPEAudioSizeBytes', 'SP_VISEME_2', 'SVSFPurgeBeforeSpeak',
    'SPINTERFERENCE_NONE', 'SPSMF_SAPI_PROPERTIES',
    'SpCompressedLexicon', 'SpeechWordPronounceable', 'SDTAll',
    'SpeechPropertyLowConfidenceThreshold', 'SAFT24kHz8BitStereo',
    'SDA_No_Trailing_Space', 'DISPID_SPIGetDisplayAttributes',
    'SPWORDPRONOUNCEABLE', 'SpeechVoiceEvents',
    'SpeechCategoryAppLexicons', 'DISPID_SRGIsPronounceable',
    'ISpeechGrammarRuleStateTransitions', 'SPPS_LMA',
    'SGDSActiveUserDelimited', 'eLEXTYPE_PRIVATE3', 'SpCustomStream',
    'SAFTADPCM_44kHzMono', 'SPEI_SOUND_START',
    'SPEI_START_INPUT_STREAM', 'DISPID_SPIElements',
    'DISPID_SVAudioOutputStream', 'DISPID_SpeechRecoResult',
    ...
    'SRERecoOtherContext', 'SAFTADPCM_44kHzStereo',
    ...
    'ISpeechPhraseReplacements', 'SPVPRIORITY', 'DISPID_SVDisplayUI',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SAVolume',
    'SDTLexicalForm', 'SPEI_UNDEFINED', 'SPTEXTSELECTIONINFO',
    'SPPHRASEELEMENT', 'SPPROPERTYINFO', 'SPRS_ACTIVE_USER_DELIMITED',
    'ISpRecoGrammar', 'DISPID_SLRemovePronunciation',
    'SpeechCategoryAudioIn', 'DISPID_SDKSetLongValue',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SVSpeak', 'SECFIgnoreCase',
    'eLEXTYPE_PRIVATE11', 'SAFT11kHz8BitStereo',
    'SDA_One_Trailing_Space', 'LONG_PTR', 'SVP_8', 'SPAUDIOOPTIONS',
    'DISPID_SRSSupportedLanguages', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SDKSetBinaryValue', 'DISPID_SRCResume', 'SRSInactive',
    'SVP_0', 'DISPID_SPERetainedSizeBytes', 'SAFTCCITT_ALaw_8kHzMono'
]

_check_version('1.2.0', 1696989048.296020)
